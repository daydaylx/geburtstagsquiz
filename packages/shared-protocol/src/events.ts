export const EVENTS = {
  ...
  DISPLAY_CONNECT_ROOM: "display:connect-room",
  DISPLAY_ROOM_CONNECTED: "display:room-connected",
  HOST_CREATE_ROOM: "host:create-room",
  HOST_ROOM_CREATED: "host:room-created",
  HOST_DISPLAY_PAIRED: "host:display-paired",
...
export const SERVER_TO_HOST_EVENT_NAMES = [
  ...
  EVENTS.HOST_ROOM_CREATED,
  EVENTS.HOST_DISPLAY_PAIRED,
